<template>
    <div class="bg-gray-900 pt-2 sm:pt-2 lg:pt-2">
       <footer class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
             <div class="col-span-full lg:col-span-2">
                <div class="lg:-mt-2 mb-4">
                   <a href="/" class="inline-flex items-center text-gray-100 text-xl md:text-2xl font-bold gap-2.5" aria-label="logo">
                ...
                <div class="flex gap-4">
                   ...
                   <a href="https://github.com/Hypefox-Studios/" target="_blank" class="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100">
                      <svg class="w-5 h-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
             ...
             <div>
                ...
                <nav class="flex flex-col gap-4">
                   <div>
                      <a href="#" class="text-gray-400 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Portfolio</a>
                   </div>
                   <div>
          ...
          <div class="text-gray-400 text-sm text-center border-t border-gray-800 py-8">© {{ year }} <b>Hypefox Studios LTD</b> (<b>14423502</b>). Registered in <b>England and Wales</b>. Licensed under <b>GNU GPL v2</b>.</div>
       </footer>
    </div>
</template>
